# Servidor de Encuestas con REST, gRPC y MongoDB
**ICC-352 Programación Web – PUCMM**

> Almy Ventura – 10153712 | Maria Jose Cruz – 10164963  
> 12 de Abril 2026
...
4. [Puertos y Servicios](#4-puertos-y-servicios)
5. [Credenciales](#5-credenciales)
...
| gRPC + Protobuf | 1.63.0 / 3.25.3 | Comunicación remota |
| MongoDB Atlas + Morphia | 2.5.1 | Base de datos |
| JWT (jjwt) | 0.12.3 | Autenticación |
| Jackson | — | Serialización JSON |
| Gradle + Shadow Plugin | 9.2 | Build y fat JAR |
...
│   │   └── estilos.css
│   ├── js/
│   │   └── (base.js, db.js, paginacion.js, sw.js, syncmanager.js, syncworker.js)
│   └── img/
│       └── logo.png
│
...
> ⚠️ **Este archivo debe crearlo manualmente** ya que contiene información sensible y no se incluye en el repositorio.
...
2. Crear el archivo `src/main/resources/config.properties` con las credenciales de MongoDB (ver sección anterior).
...
🔗 **Enlace a la aplicación:** [https://gestion-encuestas-pucmm.aovp.dev/](https://gestion-encuestas-pucmm.aovp.dev/)
